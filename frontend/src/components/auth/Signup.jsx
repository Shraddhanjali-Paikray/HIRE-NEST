...
const Signup = () => {
  ...
  const submitHandler = async (e) => {
    ...
    const formData = new FormData();  //Used for sending:text + file together
    ...
    try {
      ...
      const res = await axios.post(`${USER_API_END_POINT}/register`, formData, {
        ...
        withCredentials: true, //send cookies(used for auth/session)
      });
      if (res.data.success) { //if api worked
        navigate("/login");//redirect user
        toast.success(res.data.message);//shows success message
      }
    } catch (error) {
      console.log(error);
        ...
        >
          ...
          <div className="flex flex-col gap-1.5 mb-4">
            ...
            <Input
              ...
              className={`h-11 rounded-lg border ${errors.fullname ? "border-red-500" : "border-[#d9cdb8]"
          ...
          <div className="flex flex-col gap-1.5 mb-4">
            ...
            <Input
              ...
              className={`h-11 rounded-lg border ${errors.phoneNumber ? "border-red-500" : "border-[#d9cdb8]"
                } bg-white text-[#2c2415] text-sm px-3 focus-visible:ring-2 focus-visible:ring-[#4a6741] focus-visible:border-[#4a6741] placeholder:text-[#b5a898]`}
            />
            {errors.phoneNumber && (
          ...
          <div className="flex flex-col gap-1.5 mb-6">
            ...
            <Input
              ...
              className={`h-11 rounded-lg border ${errors.file ? "border-red-500" : "border-[#d9cdb8]"

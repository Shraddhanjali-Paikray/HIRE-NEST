    ...
    return (
        <div>
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="sm:max-w-[425px] bg-[#faf7f2] border border-[#d9cdb8]">
                    <DialogHeader>
                    ...
                    <form onSubmit={submitHandler}>
                        <div className='grid gap-4 py-4'>
                            ...
                            <div className='grid grid-cols-4 items-center gap-4'>
                                <Label htmlFor="profilePhoto" className="text-right text-[#6b5c45] text-sm">Photo</Label>
                                <Input
                                    id="profilePhoto"
                                    name="profilePhoto"
                                    type="file"
                                    ...
                                    className="col-span-3 border-[#d9cdb8] bg-white text-[#6b5c45]"
                                />
                            </div>

                            <div className='grid grid-cols-4 items-center gap-4'>
                                <Label htmlFor="file" className="text-right text-[#6b5c45] text-sm">Resume</Label>
                                <Input
                                    id="file"
                                    name="file"
                                    type="file"

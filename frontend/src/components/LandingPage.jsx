...
const VettedBadge = () => (
  <svg viewBox="0 0 320 40" width="320" height="40" xmlns="http://www.w3.org/2000/svg">
...
const LandingPage = () => {
  ...
  return (
    <div style={{ backgroundColor: "#f5f2e8", minHeight: "100vh", fontFamily: "Georgia, serif" }}>
      ...
      <section style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1.25rem", maxWidth: "680px", width: "100%", textAlign: "center" }}>
          ...
          <img src={NestLogo} alt="Hire Nest Logo"
            style={{ width: "15rem", height: "15rem", objectFit: "contain", filter: "drop-shadow(0 2px 6px rgba(74,103,65,0.10))" }} />
          ...
          <p style={{
            ...
            fontSize: "0.95rem", letterSpacing: "0.03em", lineHeight: 1.75,
            maxWidth: "440px", marginTop: "-4px",
          }}>
          ...
          <div style={{
            ...
            />
            <span style={{ width: "1px", background: "#d9cdb8", alignSelf: "stretch", margin: "8px 0" }} />
        ...
        <div style={{
          ...
          {stats.map(({ icon: Icon, label, value }) => (
            <div key={label} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5rem" }}>
              ...
              <span style={{ fontSize: "1.6rem", fontWeight: 800, color: "#2c2415", fontFamily: "Georgia, serif" }}>
                {value}
              </span>
      ...
      {/* ══ CATEGORY SECTION ════════════════════════════════════ */}
      <section style={{ padding: "5rem 1.5rem", backgroundColor: "#f5f2e8" }}>

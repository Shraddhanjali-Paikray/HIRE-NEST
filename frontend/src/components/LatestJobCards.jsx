...
const LatestJobCards = ({job}) => {
    ...
    return (
        <div onClick={()=> navigate(`/description/${job._id}`)} className='p-5 rounded-xl shadow-sm bg-[#fdfaf4] border border-[#e0d5c0] cursor-pointer hover:shadow-md hover:border-[#c8b878] transition-all duration-200'>
